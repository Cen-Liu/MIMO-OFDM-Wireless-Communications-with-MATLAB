...
subplot(427)
plot(1:num_ch, num_sig_e_paths, 'b-', [1 num_ch], mean_sig_e_paths*[1 1], 'r--');
...
xlabel('Delay [ns]'), ylabel('Average Power [dB]')
subplot(426)
...
legend(figh, 'Per-channel energy', 'Mean', '\pm Std. deviation','Location','southeast')
...
% File #2: cmX_imr.csv can open with Excel n'th pair of columns contains 
% the (time,value) pairs for the n'th realization
