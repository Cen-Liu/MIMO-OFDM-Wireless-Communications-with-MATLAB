...
plot(SNR_dB,C_44_iid,'k-', SNR_dB,C_44_corr,'b:');
xlabel('SNR [dB]'); ylabel('Ergodic Capacity [bps/Hz]'); set(gca,'fontsize',10)
legend('IID 4x4 Channels','Correlated 4x4 Channels','Location','northwest'); grid on