...
L_frame=130;  N_packet=10000; 
b=1;  % Set to 1/2/3/4 for BPSK/QPSK/16QAM/64QAM
...
title('Performance of MRC for Rayleigh fading channels'), xlabel('SNR[dB]'), ylabel('BER') 
